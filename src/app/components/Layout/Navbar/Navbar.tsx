    ...
    <nav className='min-w-16 h-screen bg-[#1e3e58]'>
      <ul className='flex flex-col gap-1 '>
        <li className={`${styles.logo} bg-[#183247] `}>
          <Link href={'/'}>
            <Image
              src='https://fassets.freshdesk.com/production/a/assets/images/svg/global-flat/freshdesk-white-92da2ff51600a79b1e9a1524d0ed94f87545e7838239fced80bb77e4ba1aaec9.svg'
              alt='Freshdesk logo'
              width={32}
              height={32}
            />
